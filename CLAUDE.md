...
- **Next: Phase 2 (Feature Synthesis)** — generate the comparative matrix from `feature_matrix`, then the **director cherry-pick session** (hard requirement: user input) → `docs/REQUIREMENTS.md`.
